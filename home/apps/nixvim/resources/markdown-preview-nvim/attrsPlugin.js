function attrsPlugin(md) {
  return attrsPlugin.markdownItAttrs(md);
}

// See https://github.com/arve0/markdown-it-attrs/blob/master@%7B2025-12-12%7D/markdown-it-attrs.browser.js
(function (f) {
  attrsPlugin.markdownItAttrs = f();
})(function () {
          ...
          function test(tokens, i, t) {
            ...
            var _loop3 = function _loop3() {
                ...
                switch (_typeof(t[key])) {
                  ...
                  default:
                    throw new Error(
                      "Unknown type of pattern test (key: ".concat(
                        key,
                        "). Test should be of type boolean, number, string, function or array of functions.",
                      ),
                    );
                }
              },
            ...
            if (options.allowedAttributes && options.allowedAttributes.length) {
              ...
              return attrs.filter(function (attrPair) {
                ...
                function isAllowedAttribute(allowedAttribute) {
                  return (
                    attr === allowedAttribute || (allowedAttribute instanceof RegExp && allowedAttribute.test(attr))
                  );
                }
